...
//   }, []);
  ...
  return (
        <div className="relative min-h-screen w-full bg-[#100D20] text-white font-sans overflow-hidden">
            ...
            <WavyBackground />
            <div className="relative z-10 flex flex-col items-center justify-between min-h-screen px-4 sm-6 lg-8 py-8">
                ...
                <main className="flex flex-col items-center justify-center text-center space-y-10 flex-grow mt-20 md-0">
                    <h1 className="text-5xl sm-6xl lg-7xl font-extrabold max-w-4xl leading-tight">
                    ...
                    <div className="flex flex-col md-row items-center justify-center gap-6 pt-8 w-full max-w-3xl">
